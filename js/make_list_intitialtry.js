...
function makelist(search) {
	...
	/////MIGHT BE EASIER TO USE AJAX...TEST THI///////
...
// 			var songuri = val.uri;
// 			console.log("***data***for each song uri = "+songuri);
// 			$.getJSON(songuri+"?format=json", function(songdet) {
// 				console.log("***data*** details of each song = ");
// 				console.log(songdet);
// 			});
// 			
// 		});
...
// 	});
    ...
    $.getJSON(url, function(data) {
        ...
        console.log("***songs by the selected artist***");
        console.log(data);
		
		/*used to be for each artists get the performances*/
        ///TRYING WITHOUT THIS
        //$.each(artists, function(i, val) {
            ...
            //console.log(val.performances);
				...
				///WITH THIS
				$.getJSON(search+"?format=json", function(ss) {
					console.log("$.getJSON(search+'?format=json', function(ss) {");
					console.log("ss = list of all songs by searched artist");
					
					
                    $.each(ss, function(ssi, ssval) {
                    	///for each song in ss, ssi = index, ssval = songObject
                        //console.log("for each ss: "+ss);
                        //console.log("ssi: "+ssi);
                        //console.log("ssval: "+ssval);
                        
                        $.getJSON(ssval.uri+"?format=json", function(x) {
